...
namespace bookcity.repository.Base
{
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class,new()
    {
        ...
        //public DataSet StoredSqlServerProcedure(string procedureName, params IDataParameter[] commandParameters)
        //{
        //    return SQLHelper.CurrentSqlServer.ExecuteDataSetbyProcedure(procedureName, commandParameters);
        //}
        /// <summary>
        /// 存储过程BaseRepository
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<object> StoredProcedure(string sql, object parameters)
        {
            ...
            // //ageP.value可以拿到返回值
            // //http://www.codeisbug.com/Doc/8/1133
            return await _db.Ado.UseStoredProcedure().GetDataTableAsync(sql, parameters);
